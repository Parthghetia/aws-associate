- [SDLC Automation](#sdlc-automation)
  ...
  - [Continuous Delivery](#continuous-delivery)
    - [Continuous Delivery vs Continuous Automation](#continuous-delivery-vs-continuous-automation)
    - [Technology Stacks to be used by CI/CD](#technology-stacks-to-be-used-by-cicd)
- [AWS CodeCommit (AWS' own Github)](#aws-codecommit-aws-own-github)
        - [NOTE: When SSHing to your code repo. There is one setting that is missing from the official AWS doc](#note-when-sshing-to-your-code-repo-there-is-one-setting-that-is-missing-from-the-official-aws-doc)
  - [Securing Repos and Branches in CodeCommit](#securing-repos-and-branches-in-codecommit)
  - [Creating Notification Rules and Triggers for your Repo](#creating-notification-rules-and-triggers-for-your-repo)
  - [CodeCommit and AWS Lambda](#codecommit-and-aws-lambda)
  - [CodeBuild](#codebuild)
  - [CodeBuild Environment Variables](#codebuild-environment-variables)
  - [CodeBuild Artifacts and S3](#codebuild-artifacts-and-s3)
  - [Eventbridge, CloudWatch for CodeBuild](#eventbridge-cloudwatch-for-codebuild)
    - [Designing an AWS CodeCommit Pull Request Validation](#designing-an-aws-codecommit-pull-request-validation)
    - [IMPORTANT - Always read DevOps Blogs linked below - Most probably your issue is already solved by someone somewhere](#important---always-read-devops-blogs-linked-below---most-probably-your-issue-is-already-solved-by-someone-somewhere)
- [AWS CodeDeploy](#aws-codedeploy)
  - [AWS CodeDeploy Hands On](#aws-codedeploy-hands-on)
      - [CodeDeploy - Deployment Configurations](#codedeploy---deployment-configurations)
    - [appspec.yml - Deep Dive](#appspecyml---deep-dive)
      - [CodeDeploy - Hooks And Environment Variables](#codedeploy---hooks-and-environment-variables)
  - [CodeDeploy - EventBridge Integration - Hands On](#codedeploy---eventbridge-integration---hands-on)
  - [CodeDeploy - Rollbacks](#codedeploy---rollbacks)
  - [Register Code Deploy on an on-premise instance](#register-code-deploy-on-an-on-premise-instance)
  - [CodeDeploy with AWS Lambda](#codedeploy-with-aws-lambda)
