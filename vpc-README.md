- [VPC](#vpc)
  - [Default VPC Overview](#default-vpc-overview)
    - [VPC Hands On - Without the VPC Wizard](#vpc-hands-on---without-the-vpc-wizard)
    - [VPC Subnets (IPV4) - Reserved IPs](#vpc-subnets-ipv4---reserved-ips)
    - [Subnet Hands On](#subnet-hands-on)
  - [Internet Gateways](#internet-gateways)
    - [IGW and Routing Tables - Hands On](#igw-and-routing-tables---hands-on)
    - [Bastion Hosts](#bastion-hosts)
    - [NAT Instances till DNS got lost, will add it later again](#nat-instances-till-dns-got-lost-will-add-it-later-again)
  - [NACL and Security Groups](#nacl-and-security-groups)
    - [NACL and Security Groups Hands On](#nacl-and-security-groups-hands-on)
  - [VPC Reachability Analyzer](#vpc-reachability-analyzer)
    - [VPC Reachability Analyzer - Hands On](#vpc-reachability-analyzer---hands-on)
  - [VPC Peering](#vpc-peering)
    - [VPC Peering Hands On](#vpc-peering-hands-on)
  - [VPC Endpoints](#vpc-endpoints)
    - [Types of VPC Endpoints](#types-of-vpc-endpoints)
    - [VPC Endpoints Hands On](#vpc-endpoints-hands-on)
  - [VPC Flow Logs](#vpc-flow-logs)
    - [VPC Flow Logs Syntax](#vpc-flow-logs-syntax)
      - [VPC Flow Logs Tshooting](#vpc-flow-logs-tshooting)
  - [VPC Flow Logs - Hands On](#vpc-flow-logs---hands-on)
  ...
  - [AWS Private Link - VPC Endpoint Services - used to expose services in your VPC to other VPCs](#aws-private-link---vpc-endpoint-services---used-to-expose-services-in-your-vpc-to-other-vpcs)
      - [AWS Private Link and ECS](#aws-private-link-and-ecs)
      - [AWS Private Link VPC Endpoint Services - Hands On](#aws-private-link-vpc-endpoint-services---hands-on)
  - [Transit Gateway](#transit-gateway)
  - [VPC Traffic Mirroring](#vpc-traffic-mirroring)
  - [IPv6 for VPC](#ipv6-for-vpc)
  - [Egress Only Internet Gateway](#egress-only-internet-gateway)
      - [IPv6 Routing for Egress Only Internet Gateway](#ipv6-routing-for-egress-only-internet-gateway)
