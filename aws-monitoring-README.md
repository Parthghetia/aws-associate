- [CloudWatch](#cloudwatch)
  ...
  - [Sources of CloudWatch logs](#sources-of-cloudwatch-logs)
    - [CloudWatch Logs Metric Filter and Insights](#cloudwatch-logs-metric-filter-and-insights)
    - [CloudWatch logs - S3 Export](#cloudwatch-logs---s3-export)
    - [CloudWatch Logs Subscriptions](#cloudwatch-logs-subscriptions)
    - [CloudWatch Logs Aggregration - Multi-Account, Multi-Region](#cloudwatch-logs-aggregration---multi-account-multi-region)
    - [CloudWatch logs - Hands On](#cloudwatch-logs---hands-on)
  - [Cloudwatch logs for EC2](#cloudwatch-logs-for-ec2)
  - [CloudWatch Alarms](#cloudwatch-alarms)
    - [CloudWatch Alarm Targets](#cloudwatch-alarm-targets)
      - [CloudWatch Alarm - EC2 Instance Recovery](#cloudwatch-alarm---ec2-instance-recovery)
      - [CloudWatch Alarms: Good to know](#cloudwatch-alarms-good-to-know)
        - [CloudWatch Alarms - Hands On](#cloudwatch-alarms---hands-on)
  - [Amazon EventBridge](#amazon-eventbridge)
    - [Amazon EventBridge - Schema Registry](#amazon-eventbridge---schema-registry)
    - [Amazon EventBridge - Resource Policy - To allow events from another account/region](#amazon-eventbridge---resource-policy---to-allow-events-from-another-accountregion)
  - [Amazon EventBridge - Hands On](#amazon-eventbridge---hands-on)
- [AWS CloudTrail](#aws-cloudtrail)
    - [CloudTrail High Level Overview](#cloudtrail-high-level-overview)
    - [CloudTrail Events - Management and Data Events](#cloudtrail-events---management-and-data-events)
    - [CloudTrail Insights](#cloudtrail-insights)
    - [CloudTrail Events Retention](#cloudtrail-events-retention)
    - [CloudTrail Hands On](#cloudtrail-hands-on)
- [AWS Config](#aws-config)
    - [Config Rules](#config-rules)
    - [Config Rules - Remediations](#config-rules---remediations)
    - [Config Rules - Notifications using EventBridge](#config-rules---notifications-using-eventbridge)
